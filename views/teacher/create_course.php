    ...
    <div class="row">
        ...
        <div class="col-md-2 sidebar p-0">
            ...
            <nav class="nav flex-column">
                ...
                <a class="nav-link active" href="<?= BASE_URL ?>controllers/TeacherController.php?action=create_course">
        ...
        <div class="col-md-10 p-4">
            ...
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="<?= BASE_URL ?>controllers/TeacherController.php?action=create_course">
                        <div class="row">
                            <div class="col-md-8">
                                <div class="mb-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="number" name="duration_weeks" class="form-control" min="1" required>
                                    </div>
                                </div>

                                <div class="mb-3">
                                    <label class="form-label">Hình ảnh (URL hoặc tên file)</label>
                                    <input type="text" name="image" class="form-control" placeholder="course-image.jpg">
                                    <small class="text-muted">Ví dụ: course-image.jpg hoặc https://example.com/image.jpg</small>
                                </div>

                                <div class="alert alert-info">
                                    <i class="fas fa-info-circle"></i> 
                                    <strong>Lưu ý:</strong> Khóa học sau khi tạo sẽ được gửi đến quản trị viên để phê duyệt trước khi xuất bản.
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="card bg-light">
                                    <div class="card-body">
                                        ...
                                        <ul class="small">
                                            <li>Điền đầy đủ thông tin khóa học</li>
                                            <li>Mô tả rõ ràng nội dung và mục tiêu</li>
                                            <li>Chọn danh mục phù hợp</li>
                                            <li>Sau khi tạo, bạn có thể thêm bài học và tài liệu</li>
                                            <li>Khóa học cần được admin phê duyệt</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
